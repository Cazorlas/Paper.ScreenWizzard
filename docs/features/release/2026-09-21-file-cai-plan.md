...
**Trạng thái:** đang làm (mở lại 2026-09-21 sau các câu hỏi của Hùng; đợt đầu đã xong và đã duyệt: "setup đầy đủ file cài lun nha")
**Loại việc:** code
...
- [ ] T10 Bản đầu và thẻ đầu (Hùng: "làm bản đầu và thẻ đầu đi"): chạy thử `release.yml` bằng tay, rồi đẩy thẻ `v0.1.0` và xem bản nháp có đủ ba file — xong khi bản nháp có `Setup.exe`, `.zip`, `SHA256SUMS.txt` khớp với bản dựng cục bộ, rồi xuất bản {files: .github/workflows/release.yml}
