...
- [ ] T14 [ui] View, ViewModel, bộ vẽ ra pixel (`RenderTargetBitmap`) và các công cụ của trình sửa; verb `ui`, **mở ảnh ra xem** — xong khi T13 xanh và ảnh khớp wireframe {files: src/Paper.ScreenWizzard.App/Views/Editor/**, src/Paper.ScreenWizzard.App/ViewModels/Editor/**, src/Paper.ScreenWizzard.App/Rendering/**, src/Paper.ScreenWizzard.App/Resources/**, tests/Paper.ScreenWizzard.UiTests/Editor/**}
